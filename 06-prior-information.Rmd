...
And the same as if our prior knowledge about the sex ratio had the same information content as sampling 132 males out of 300 fish and we had yet to collect any data.
```{r}
set.seed(42)
