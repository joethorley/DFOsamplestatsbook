...
If they were fit the equivalent Bayesian model then even with an uninformative prior they would still conclude that the sex ratio was significantly different from 50:50 but their estimate (if using the median value of the posterior probability) would be that approximately 10% of the run was female.
...
If they were to fit the Bayesian model with a weakly informative prior then they would estimate that about 40% of the run was female although they would consider in reasonably likely that females make up 60% of the run.
