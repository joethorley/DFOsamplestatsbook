...
Important decisions should be based on the estimated consequences (with uncertainty) of alternative actions on human values [@hemming_introduction_2022]. 
However, less consequential decisions such as how many salmonids to tag can be based on simpler heuristics. 
